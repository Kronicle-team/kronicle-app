...
const PrivacyPolicyPage = () => {
    return (
        <Layout className={style["policy-container"]} header footer>
            <div>
                <h1>Privacy Policy for Kronicle</h1>

                <p>At Kronicle, accessible from https://github.com/Kronicle-team/kronicle-app, one of our main
                    priorities is the privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by Kronicle and how we use it.</p>

                <p>If you have additional questions or require more information about our Privacy Policy, do not
                    hesitate to contact us.</p>

                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in Kronicle. This policy is not
                ...
                <p>Kronicle follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <p>Like any other website, Kronicle uses 'cookies'. These cookies are used to store information
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on Kronicle, which are sent
                ...
                <p>Note that Kronicle has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>Kronicle's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
                ...
                <p>Kronicle does not knowingly collect any Personal Identifiable Information from children under the age
