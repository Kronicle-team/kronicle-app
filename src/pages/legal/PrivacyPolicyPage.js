  ...
  return (
    <Layout className={style["policy-container"]} header footer>
      <div>
        ...
        <p>At Kronicle, accessible from https://github.com/Kronicle-team/kronicle-app, one of our main priorities is the
        ...
        <p>Kronicle follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        <p>Like any other website, Kronicle uses 'cookies'. These cookies are used to store information including
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Kronicle.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used in their respective advertisements and links that appear on Kronicle, which are sent directly to users'
        ...
        <p>Kronicle's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>Kronicle does not knowingly collect any Personal Identifiable Information from children under the age of 13.
