        ...
        <Layout header footer>
            <div className={style["tos-container"]}>
                    ...
                    <li>
                        <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms
                            ...
                            Service. This Terms and Conditions agreement has been created with the help of the <a
                                ...
                                target="_blank">Terms and Conditions Template</a>.</p>
                    </li>
                    <li>
                ...
                <p>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be
                    ...
                    otherwise in
                    connection with any provision of this Terms), even if the Company or any supplier has been advised
                    of
                ...
                <p>The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and with all faults and
                    ...
                    applications,
                    systems or services, operate without interruption, meet any performance or reliability standards or
                    be
                ...
                <p>Without limiting the foregoing, neither the Company nor any of the company's provider makes any
                    ...
                    Service will be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of
                    any
                ...
                <p>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on
                    applicable
                    statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply
                    to
                    You. But in such a case the exclusions and limitations set forth in this section shall be applied to
                    the
                ...
                <ul>
                    <li>By email: kronicle-suppoer@gmail.com</li>
                </ul>
            </div>
            <ToTopButton/>
        </Layout>
